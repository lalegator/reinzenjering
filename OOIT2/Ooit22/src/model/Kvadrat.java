...
public class Kvadrat extends PovrsinskiOblik implements Comparable{
	...
	public void selektovan (Graphics g){
		...
		new Linija( new Tacka(goreLevo.getX(), goreLevo.getY()+stranica), new Tacka(goreLevo.getX()+stranica, goreLevo.getY()+stranica)).selektovan(g);;
		new Linija(new Tacka(goreLevo.getX()+stranica, goreLevo.getY()+stranica),new Tacka(goreLevo.getX()+stranica, goreLevo.getY())).selektovan(g);	;	
	...
	public boolean equals (Object obj){
		if (obj instanceof Kvadrat){
			...
			if (goreLevo.equals(pomocni.getGoreLevo()) && stranica == pomocni.getStranica())
				return true;
			else
				return false;	
		}
