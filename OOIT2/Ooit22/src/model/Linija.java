...
public class Linija extends Oblik implements Comparable {
	...
	/*
	 * public void selektovan(Graphics g){ g.setColor(pronadjiBoju("plava"));
	 * g.drawRect(tPocetna.getX()-3, tPocetna.getY()-3, 6, 6);
	 * g.drawRect(tKrajnja.getX()-3, tKrajnja.getY()-3, 6, 6);
	 * g.drawRect(sredisnjaTackaLinije().getX()-3,
	 * sredisnjaTackaLinije().getY()-3, 6, 6); }
	 */
	...
	public boolean eguals(Object obj) {
		if (obj instanceof Linija) {
			...
			if (tPocetna.equals(pomocna.tPocetna)
					&& this.tKrajnja.equals(pomocna.gettKrajnja())
	...
	public String toString() {
		/*
		 * String s =
		 * "("+tPocetna.getX()+","+tPocetna.getY()+")"+"("+tKrajnja.getX
		 * ()+","+tKrajnja.getY()+")"; return s;
		 */
