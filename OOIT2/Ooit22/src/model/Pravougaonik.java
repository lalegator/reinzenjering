...
public class Pravougaonik extends Kvadrat implements Comparable {
	...
	public void selektovan(Graphics g) {
		...
		new Linija(goreLevo, new Tacka(goreLevo.getX(), goreLevo.getY()
				+ visina)).selektovan(g);
		;
		new Linija(new Tacka(goreLevo.getX(), goreLevo.getY() + visina),
				new Tacka(goreLevo.getX() + stranica, goreLevo.getY() + visina))
				.selektovan(g);
		;
		new Linija(new Tacka(goreLevo.getX() + stranica, goreLevo.getY()
				+ visina), new Tacka(goreLevo.getX() + stranica,
				goreLevo.getY())).selektovan(g);
		;
	...
	public String toString() {
		String s = "gornji levi ugao=" + goreLevo + ", sirina=" + stranica
				+ ", visina=" + visina;
		return s;
	}
	...
	public double Povrsina() { /*
								 * ne pise se get, nego nam to govori da ova
								 * metoda nesto vraca
								 */
